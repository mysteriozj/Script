...
[task_local]
# 小米运动
15 17 * * * https://raw.githubusercontent.com/mysteriozj/Script/master/js/xmSports1.js, tag=小米运动, img-url=https://gitee.com/piggybl/scripts/raw/master/AppIcon/xmsport.png, enabled=true
[rewrite_local]
# 小米运动获取Token
^https:\/\/account\.huami\.com\/v2\/client\/login url script-response-body https://raw.githubusercontent.com/mysteriozj/Script/master/js/xmSports1.js
 */
...
const step = randomFriendPin($.getdata('xmMinStep')*1 || 6000, $.getdata('xmMaxStep')*1 || 80000);
function getToken() {
  if ($response.body) {
